export default {
  ...
  timelineText1part1: 'The core of ',
  timelineText1part2: 'employees was formed in 2018 and worked under the brand',
  timelineTextSpan: '"Taor Development"',
  timelineText1part3: 'for several years',
  timelineText2: 'Reconstruction on the ',
  timelineText2span: 'Popovicha, 9 st.',
  timelineText3: 'Reconstruction on the ',
  timelineText3span: 'Hryhorovycha, 8 st.',
  timelineText4: 'Reconstruction on the ',
  timelineText4span: 'Zaliznychna, 7 st.',
  ...
  ostapText2: 'Ostap is a lawyer by education and has been working in the development field for more than 20 years. During this time, he gained a lot of practical and professional experience and learned an important lesson for him - delegation of duties and mutual trust in the company – is, actually, a very ',
  ostapText2span: '"cool thing"',
  ostapText2part: ' that is a basis of business.',
  ihorKovalchuk: 'IHOR KOVALCHUK',
  ihorTextTitle: 'Chief engineer',
  ihorText1: 'with many years of experience in design and construction. Who participated in creation pf Iconic project - “Ukreximbank" building on Mickiewicz square, 4. ',
  ihorText1part: 'This object was awarded the international award in the field of construction "Kryshtaleva Tseglyna".',
  ihorText2: 'He also oversaw design and construction of the university campus of UCU on ',
  ihorText2part: 'the Kozelnytska - ',
  ihorText2part2: 'Stryyska st. And has been working in our team since 2019.',
  teamName1: 'Pavlo Kvasnytsia ',
  teamName2: 'Vitaly Galayko',
